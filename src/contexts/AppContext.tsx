...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  // NOTE: Realtime listener REMOVED for cross-platform consistency.
  // The useChamadoQueue hook handles all chamado discovery via polling.
  // This ensures Chrome, PWA, and TWA all behave identically.
