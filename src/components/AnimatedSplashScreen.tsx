  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center justify-center" style={{ width: 320, height: 400 }}>
        ...
        >
          <img src={iconGuincho} alt="Guincho" className="w-24 h-auto drop-shadow-lg" />
        </motion.div>
        ...
        <motion.div
          ...
          transition={{ duration: 0.5, ease: "backOut" }}
        >
          <img src={iconChaveiro} alt="Chaveiro" className="w-24 h-auto drop-shadow-lg" />
        </motion.div>
        ...
        <motion.div
          ...
          transition={{ duration: 0.5, ease: "backOut" }}
        >
          <img src={iconMecanica} alt="Mecânica" className="w-24 h-auto drop-shadow-lg" />
        </motion.div>
        ...
        <motion.div
          ...
          transition={{ duration: 0.5, ease: "backOut" }}
        >
          <img src={iconBorracharia} alt="Borracharia" className="w-24 h-auto drop-shadow-lg" />
        </motion.div>
