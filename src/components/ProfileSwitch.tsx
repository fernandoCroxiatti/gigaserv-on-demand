...
export function ProfileSwitch() {
  ...
  return (
    <div className="flex items-center gap-0.5 sm:gap-1 p-0.5 sm:p-1 bg-secondary rounded-xl sm:rounded-2xl flex-shrink min-w-0">
      <button
        onClick={() => setActiveProfile('client')}
        className={`flex items-center gap-1 sm:gap-2 px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg sm:rounded-xl text-xs sm:text-sm font-medium transition-all duration-300 whitespace-nowrap ${
          isClient
